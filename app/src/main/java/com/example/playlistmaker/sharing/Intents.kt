...
object Intents {
    ...
    fun intentCallWithKeySerializable(activity: Activity, activityClass: Class<PlayerActivity>, keyName: String, keyValue: Track){
        val intent = Intent(activity, activityClass).apply {
    ...
    fun intentCallWithKeySerializableOld(activity: Activity, activityClass: Class<out AppCompatActivity>, keyName: String, keyValue: Track){
        val intent = Intent(activity, activityClass).apply {
            putExtra(keyName, keyValue as Serializable)
        }
        activity.startActivity(intent)
