...
//import com.example.playlistmaker.data.search.network.TracksApi
//import com.example.playlistmaker.data.search.network.TracksRetrofit
...
//    private lateinit var externalNavigator: ThemeRepositoryImpl
...
//        //externalNavigator = ThemeRepositoryImpl(getSharedPreferences(PLAY_LIST_PREFERENCES, MODE_PRIVATE))
//    }
//
...
////        ExternalNavigatorRepositoryImpl.intentCallWithKeySerializable(
////            this,
